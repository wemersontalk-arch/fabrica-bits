...
import { Crown, Sparkles, Check, ArrowRight, ShieldCheck, Zap, Clock, X, MessageSquare, CheckCircle2, Lock } from 'lucide-react';

export default function PlanosPage() {
  const { user, addToWaitlist } = useAuth();
            ...
            >
              ...
              <div className="pt-4 border-t border-slate-800">
                {p.isComingSoon ? (
                  ...
                  <button
                    onClick={() => handleOpenWaitlist(p.id === 'pro' ? 'pro' : 'agency')}
